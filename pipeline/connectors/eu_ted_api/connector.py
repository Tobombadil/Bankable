...
FIELDS = ["publication-number", "notice-title", "buyer-name", "buyer-country", "publication-date",
          "deadline-receipt-tender-date-lot", "notice-type", "contract-nature", "classification-cpv",
          "place-of-performance", "form-type", "estimated-value-glo", "estimated-value-cur-glo", "procedure-type",
          "total-value", "total-value-cur"]
CPV_QUERY = "(classification-cpv=09* OR classification-cpv=31* OR classification-cpv=45231* OR classification-cpv=71314*)"
PAGE = 100
MAX_PAGES = 30
WINDOW_DAYS = 3
KIND_BY_PREFIX = {"pin": "procurement_notice", "cn": "tender", "can": "tender", "veat": "tender", "qu": "tender",
                  "subco": "tender", "brin": "procurement_notice"}
CPV_TECH = {"093": "solar_pv", "09330000": "solar_pv", "09331000": "solar_pv", "09332000": "solar_pv",
            "45251100": "wind", "45251120": "hydro", "45251143": "nuclear", "45231400": "transmission",
            "45231220": "gas", "45231221": "gas", "45231223": "gas", "45232220": "transmission",
            "31121": "gas", "31122": "gas", "31210000": "transmission", "31170000": "transmission",
            "31200000": "transmission", "45251111": "nuclear", "09111": "coal", "09120000": "gas",
            "09123000": "gas", "45231210": "gas", "71314": "efficiency"}
...
class Connector(BaseConnector):
    ...
    key_source_columns: ClassVar[tuple[str, ...]] = ("publication-number", "notice-title", "notice-type",
    ...
    def fetch(self) -> RawSnapshot:
        ...
        for page_no in range(1, MAX_PAGES + 1):
            ...
            if not page.get("notices") or seen >= int(page.get("totalNoticeCount", 0)):
                break
        payload = json.dumps({"request": {"query": query, "fields": FIELDS}, "pages": pages},
    ...
    def normalize(self, rows: list[dict[str, Any]], raw: RawSnapshot) -> pd.DataFrame:
        ...
        for r in rows:
            ...
            ctx = {"status_raw": ntype, "form_type": r.get("form-type"), "deadline_passed": deadline_passed(due, now)}
            ...
            recs.append({
                ...
                "identifiers": json.dumps({"ted_notice_id": r.get("publication-number"), "cpv": sorted(set(cpv)),
