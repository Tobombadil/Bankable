...
def proposal_status_changed(**overrides: object) -> SocialEvent:
    fields = {
        **_PROPOSAL_BASE,
        ...
        "subject_id": "caiso:2",
        "page_url": "https://infraque.com/proposals/caiso:2",
        "technology": "solar",
        "capacity_mw": 250.0,
        "state": "CA",
        "iso_rto": "CAISO",
...
def proposal_withdrawn(**overrides: object) -> SocialEvent:
    fields = {
        **_PROPOSAL_BASE,
        ...
        "subject_id": "ercot:1",
        "page_url": "https://infraque.com/proposals/ercot:1",
        "technology": "storage",
        "capacity_mw": 300.0,
        "county": "Ward",
        "state": "TX",
...
def rfp_opened(**overrides: object) -> SocialEvent:
    fields = {
        **_OPPORTUNITY_BASE,
        ...
        "subject_id": "rfp:1",
        "page_url": "https://infraque.com/opportunities/rfp:1",
...
def funding_change(event_type: str, **overrides: object) -> SocialEvent:
    fields = {
        **_OPPORTUNITY_BASE,
        ...
        "subject_id": "grant:1",
        "page_url": "https://infraque.com/opportunities/grant:1",
...
def digest_weekly(**overrides: object) -> SocialEvent:
    fields = {
        **_OPPORTUNITY_BASE,
        ...
        "page_url": "https://infraque.com/digest/2026-W37",
        "digest_items": (
