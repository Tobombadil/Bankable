...
| `eia860_owner_2024_sample.zip` | `us.eia.860` | `https://www.eia.gov/electricity/data/eia860/archive/xls/eia8602024.zip` (`4___Owner_Y2024.xlsx`, one-off human-equivalent download for this fixture, 2026-09-18 — not something the connector itself fetches, see its docstring) | "Ownership" sheet, title row + header + 60 rows (57 in original file order plus the 3 messy real rows: one with no Generator ID, two with a blank Percent Owned) |
