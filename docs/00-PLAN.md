...
1. **Name.** The owner will choose a new name. Until then, use "the platform" in prose and `{{PRODUCT}}` /
   `{{DOMAIN}}` where a literal is unavoidable. Checks before adoption: .com or equivalent domain, USPTO and EUIPO
