...
Items 1 to 4 are landed and verified (decisions log rows "Sprint 3 first wave landed", "Admin backend landed",
"Admin panel UI landed", "Workers landed"). Next in order: item 5, the data follow-ups.
