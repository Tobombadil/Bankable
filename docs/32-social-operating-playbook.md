...
**Formats.**
- RSS/Atom: one feed per region × technology × event type, plus a global feed. Free and public, and **not delayed** — nothing has been since 2026-09-21, so an item appears as soon as it is published (`pubDate` = `public_at`, which now equals `published_at`). Each item: title, structured summary, link to proposal page, `source` attribution.
...
|---|---|---|---|
| `proposal.new` | capacity ≥ 50 MW, or ≥ 100 MW for solar/storage in high-volume ISOs, or load ≥ 100 MW, or transmission ≥ 100 kV, or capex ≥ $100m where stated | Bluesky, X; LinkedIn if ≥ 200 MW / ≥ $250m / nuclear, LNG, CCS, transmission ≥ 230 kV | Public-tier release, which since 2026-09-21 is publication itself for every shape, records and change events alike |
