...
| Object storage | **Cloudflare R2** (S3 API) | Zero egress fees for public documents and exports; Cloudflare already fronts bankablehq.com (`.github/workflows/blank.yml`) | AWS S3 (fine if hosting moves to AWS) |
